...
public class DemoHeapSort 
{
	...
	public static void main(String[] args) throws IOException
	{
		...
		HeapSort engine = new HeapSort();
		int i=0;
		
		if(args.length != 2 || args[0].equalsIgnoreCase("help"))
		{
			System.out.println("Argument is empty! Please provide the path of the input.txt");
			System.out.println("HeapSort Path/to/input.txt Path/to/output.txt");
			return;
		}
		...
		System.out.println("Start to do the HeapSort, and the Current Time is " + (startTime=System.nanoTime()));
