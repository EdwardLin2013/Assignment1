...
public class DemoQuickSort {
	...
	public static void main(String[] args) throws IOException
	{
		...
		if(args.length != 2 || args[0].equalsIgnoreCase("help"))
		{
			...
			System.out.println("QuickSort Path/to/input.txt Path/to/output.txt");
			return;
		}
		...
		System.out.println("Start to do the QuickSort, and the Current Time is " + (startTime=System.nanoTime()));
		outputArray = (ArrayList<Integer>) engine.sort(inputArray, 0, inputArray.size()-1);
